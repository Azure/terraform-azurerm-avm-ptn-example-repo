  ...
  - name: TEST ONLY - Prepare controlled gate input
    ...
    with:
      script: |
        ...
        if (comments.length !== 1 || comments[0].item_number !== issue ||
            comments[0].data?.fixing_pr !== 227 || comments[0].data?.fix_confidence !== 'confirmed' ||
            comments[0].data?.release_action !== 'evaluate_fix')
